...
import { TableSkeleton, TableRowSkeleton } from './Skeleton';
      ...
      <div className="p-5 border-b border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4 bg-slate-50/45">
        <div className="relative w-full md:max-w-xs">
          ...
          <input
            ...
            disabled={loading}
            className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl text-xs font-semibold bg-white focus:outline-none focus:ring-2 focus:ring-farm-500/20 focus:border-farm-500 hover:border-slate-350 transition-all placeholder-slate-400 disabled:opacity-50"
